...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #0a0f1c, #0f2027, #1b2a38); /* lebih gelap */
            display: flex;
        ...
        .container {
            background: rgba(15, 32, 47, 0.9); /* lebih gelap */
            padding: 25px;
            border-radius: 15px;
            box-shadow: 0px 0px 25px rgba(0, 212, 255, 0.3); /* glow biru */
            text-align: center;
            width: 90%;
            max-width: 400px;
            color: #e0f7ff;
